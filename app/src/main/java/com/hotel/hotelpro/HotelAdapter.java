...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.HotelViewHolder> {
    ...
    private List<com.hotel.hotelpro.Hotel> hotels;
    private com.hotel.hotelpro.HotelResult hotelResult = new com.hotel.hotelpro.HotelResult();
    ...
    public void setHotels(List<com.hotel.hotelpro.Hotel> lists) {
        this.hotels = lists;
        hotelResult.setHotels(hotels);
        com.hotel.hotelpro.HotelResult hotelResult = new com.hotel.hotelpro.HotelResult();
        hotelResult.setHotels(hotels);
    ...
    public void onBindViewHolder(@NonNull HotelViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.bookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setHotels(hotels);
                Intent i = new Intent(context, com.hotel.hotelpro.HotelInfo.class);
